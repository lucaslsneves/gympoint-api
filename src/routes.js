...
import CanceledPlanController from './app/controllers/CanceledPlanController';
...
routes.get('/plans/canceled', CanceledPlanController.index);
routes.put('/plans/canceled/:id', CanceledPlanController.update);
